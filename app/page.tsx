...
import {
  ...
  applicationCountRanges,
  interviewCountRanges,
  departmentOptions,
  positionOptions,
  cvPreferences,
...
export default function Home() {
      ...
      if (response.ok) {
        ...
        if (data.missingFields) {
          toast.error("Eksik alanlar var", {
            description: data.missingFields
              .map((field: string) => `• ${getFieldLabel(field)}`)
              .join("\n"),
            duration: 5000,
          });
        } else {
  ...
  const isCurrentStepValid = () => {
    switch (currentStep) {
      ...
      case 6:
        return formData.hrCommunicationSatisfaction;
      default:
        return true;
    }
  };
          ...
          <div className="space-y-3">
            <div className="bg-blue-50 border border-blue-200 rounded-lg p-2">
              <p className="text-sm text-blue-800 leading-relaxed">
                ...
                deneyimlerini analiz etmek ve iyileştirme önerileri geliştirmek
                için kullanılacaktır. Kişisel tanımlayıcı bilgiler talep
                edilmemekte ve veriler anonim olarak işlenmektedir. Anketi
                doldurmanız, bu koşulları kabul ettiğiniz anlamına gelmektedir.
              </p>
            </div>
            <motion.div
              key="step1"
            ...
            >
              <div className="flex flex-col gap-2">
                <p className="text-gray-600 text-[12px] sm:text-md xs:text-sm leading-relaxed border-none rounded-lg border-gray-500 p-4 bg-red-500/10 w-full">
                  ...
                  iş bulamayan bireylerin katılımı beklenmektedir.
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div>
                      <Select
                        value={
                          formData.graduationDate
                            ? (
                                new Date(formData.graduationDate).getMonth() + 1
                              ).toString()
                            : ""
                        }
                        onValueChange={(month) => {
                          ...
                          {Array.from(
                            {
                              length: new Date(
                                ...
                                formData.graduationDate
                                  ? new Date(formData.graduationDate).getMonth()
                                  : 0,
                                0
                              ).getDate(),
                            },
                ...
                <div className="lg:col-span-2">
                  <Label htmlFor="location">
                    Tercih ettiğiniz iş arama platformu
                  </Label>
                  <Select
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({ ...prev, desiredPosition: value }))
                  }
                >
                  <SelectTrigger>
              ...
              <div>
                ...
                <Select
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({ ...prev, expectedSalary: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Seçiniz" />
              ...
              <div>
                <Label className="block text-sm font-medium text-gray-700">
                  Toplam Görüşmeye Çağrılma Sayınız
                </Label>
                <Select
                  value={formData.interviewCount}
                  onValueChange={(value) =>
                    setFormData((prev) => ({ ...prev, interviewCount: value }))
                  }
                >
                  <SelectTrigger>
                    <SelectValue placeholder="Seçiniz" />
              ...
              <div>
                <Label className="block text-sm font-medium text-gray-700">
                  Günde ortalama kaç başvuru yapıyorsunuz?
                </Label>
                <Select
              ...
              <div className="lg:col-span-2">
                <Label className="text-sm font-medium text-gray-700">
                  İş başvurusunda hangi CV formatını kullanmayı tercih
                  ediyorsunuz?
                </Label>
                <RadioGroup
                  value={formData.cvPreference}
                  onValueChange={(value) =>
                    setFormData((prev) => ({ ...prev, cvPreference: value }))
                  }
                ...
                >
                  {cvPreferences.map((option) => (
                    ...
                    >
                      <RadioGroupItem
                        value={option.value}
                        id={`cvPreference-${option.value}`}
                      />
                      <Label
                        htmlFor={`cvPreference-${option.value}`}
              ...
              <div className="lg:col-span-2">
                <Label className="text-sm font-medium text-gray-700">
                  Hangi çalışma modelini tercih ediyorsunuz?
                </Label>
                <RadioGroup
                ...
                >
                  {workModelPreferences.map((option) => (
                    ...
                    >
                      <RadioGroupItem
                        value={option.value}
                        id={`workModelPreference-${option.value}`}
                      />
                      <Label
                        htmlFor={`workModelPreference-${option.value}`}
                        className="font-normal"
                      >
                        {option.label}
                      </Label>
            ...
            <div className="space-y-8">
              <div className="space-y-3">
                <Label className="text-base">
                  Şirketlerin işe alım süreçlerinin şeffaflığı ve
                  profesyonelliğinden ne kadar memnunsunuz?
                </Label>
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      hiringProcessSatisfaction: value,
                    }))
                  }
                  ...
                  {[1, 2, 3, 4, 5].map((value) => (
                    <div key={value} className="flex items-center space-x-3">
                      <RadioGroupItem
                        ...
                        id={`hiringProcess-${value}`}
                      />
                      <Label
                        htmlFor={`hiringProcess-${value}`}
                        className="font-normal"
                      >
              ...
              <div className="space-y-3">
                <Label className="text-base">
                  İş ilanlarındaki gereksinimlerin gerçekçi olup olmamasından ne
                  kadar memnunsunuz?
                </Label>
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      requirementsSatisfaction: value,
                    }))
                  }
                  className="flex flex-col space-y-1 pl-1"
                >
              ...
              <div className="space-y-3">
                <Label className="text-base">
                  İşverenlerin başvurularınıza geri bildirim verme oranından ne
                  kadar memnunsunuz?
                </Label>
                <RadioGroup
        ...
        return (
          ...
          >
            <div className="space-y-8">
              <div className="space-y-3">
                <Label className="text-base">
                  İş başvurusunda kullanılan platformlardan (LinkedIn,
                  Kariyer.net vb.) memnuniyet seviyeniz nedir?
                </Label>
                <RadioGroup
                ...
                >
                  {[1, 2, 3, 4, 5].map((value) => (
                    <div key={value} className="flex items-center space-x-3">
                      <RadioGroupItem
                        value={value.toString()}
                        id={`platformSatisfaction-${value}`}
                      />
                      <Label
                        htmlFor={`platformSatisfaction-${value}`}
                        className="font-normal"
                      >
                        {value} - {getSatisfactionLabel(value)}
                      </Label>
              ...
              <div className="space-y-3">
                <Label className="text-base">
                  Şirketlerin size iş görüşmesinden sonra geri bildirim verip
                  vermemesinden ne kadar memnunsunuz?
                </Label>
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      postInterviewFeedbackSatisfaction: value,
                    }))
                  }
                  className="flex flex-col space-y-1 pl-1"
                >
                  {[1, 2, 3, 4, 5].map((value) => (
                    <div key={value} className="flex items-center space-x-3">
                      <RadioGroupItem
                        value={value.toString()}
                        id={`postInterviewFeedback-${value}`}
                      />
                      <Label
                        htmlFor={`postInterviewFeedback-${value}`}
                        className="font-normal"
                      >
                        {value} - {getSatisfactionLabel(value)}
                      </Label>
              ...
              <div className="space-y-3">
                <Label className="text-base">
                  İşverenlerin pozisyonla ilgili olarak maaş şeffaflığı
                  uygulamaları gerektiğini düşünüyor musunuz?
                </Label>
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      salaryTransparencyOpinion: value,
                    }))
                  }
                  className="flex flex-col space-y-1 pl-1"
                >
                  {[1, 2, 3, 4, 5].map((value) => (
                    <div key={value} className="flex items-center space-x-3">
                      <RadioGroupItem
                        value={value.toString()}
                        id={`salaryTransparency-${value}`}
                      />
                      <Label
                        htmlFor={`salaryTransparency-${value}`}
                        className="font-normal"
                      >
          ...
          >
            <div className="space-y-20">
              <div className="space-y-4">
                <Label className="text-base">
                  İK ekibiyle iletişim kurmanın kolaylığından ne kadar
                  memnunsunuz?
                </Label>
                <RadioGroup
                  ...
                  onValueChange={(value) =>
                    setFormData((prev) => ({
                      ...prev,
                      hrCommunicationSatisfaction: value,
                    }))
                  }
                  className="flex flex-col space-y-1 pl-1"
                >
                  {[1, 2, 3, 4, 5].map((value) => (
                    <div key={value} className="flex items-center space-x-3">
                      <RadioGroupItem
                        value={value.toString()}
                        id={`hrCommunication-${value}`}
                      />
                      <Label
                        htmlFor={`hrCommunication-${value}`}
                        className="font-normal"
                      >
                        {value} - {getSatisfactionLabel(value)}
                      </Label>
              ...
              <div>
                <Label className="text-base">
                  İşsizlik süresi boyunca yaşadığınız zorluklar nelerdir?
                </Label>
                  ...
                  {unemploymentChallenges.map((challenge) => (
                    ...
                    >
                      <Checkbox
                        ...
                        checked={formData.unemploymentChallenges.includes(
                          challenge.value
                        )}
                        onCheckedChange={(checked) => {
                          setFormData((prev) => ({
                            ...
                            unemploymentChallenges: checked
                              ? [
                                  ...prev.unemploymentChallenges,
                                  challenge.value,
                                ]
                              : prev.unemploymentChallenges.filter(
                                  (v) => v !== challenge.value
                                ),
                          }));
                        }}
  ...
  return (
    <main className="h-screen flex items-center justify-center relative p-4 overflow-hidden">
      <div
        className="absolute inset-0 bg-cover bg-center opacity-10"
        style={{ backgroundImage: "url('/jobless.webp')" }}
      />
      <motion.div
        initial={{ opacity: 0, y: 20 }}
        animate={{ opacity: 1, y: 0 }}
        className="w-full max-w-4xl relative z-10 h-[90vh]"
      >
        <form
          onSubmit={handleSubmit}
          className="bg-white/100 backdrop-blur-none rounded-xl shadow-lg p-6 h-full flex flex-col"
        >
          <div className="mb-8">
